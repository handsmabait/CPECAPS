...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter
% define missing counters only if they are not already defined
\@ifundefined{c@Hpagenote}{\newcounter{Hpagenote}}{}
\@ifundefined{c@su@anzahl}{\newcounter{su@anzahl}}{}
\makeatother
...
\newcommand{\documentType}{Capstone Project on Operational Technologies}
...
\defineAuthor{surname1}{Calaguian}
\defineAuthor{firstname1}{Nathan Raekel L.}

\defineAuthor{surname2}{Ellar}
\defineAuthor{firstname2}{Gerald Antonio P.}

\defineAuthor{surname3}{Mahait}
\defineAuthor{firstname3}{Hans}

\newcommand{\documentTitle}{A Real-time Pose Estimation Application for Tinikling} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{Dance, Pose Estimation, Real-time, OpenPose }
...
% Fallback definition: if \appendixR is not defined by the template, define it to \appendix
\providecommand{\appendixR}{\appendix}
...
\begin{document}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\chapter{Member Skillset Identification}
\begin{table}[h!]
\centering
\caption{Team Members' Programming Skills}
\begin{tabular}{|l|p{2cm}|p{2cm}|p{2.5cm}|p{2.5cm}|p{2cm}|}
\hline
\textbf{Member} & \textbf{Model Dev.} & \textbf{UI Design} & \textbf{Source Control (GitHub)} & \textbf{Problem Solving \& Opt.} & \textbf{Python} \\ \hline
Hans   & Intermediate & Novice & Expert & Intermediate & Intermediate \\ \hline
Gerald & Intermediate & Basic  & Novice & Intermediate & Intermediate \\ \hline
Nathan & Intermediate & Novice & Novice & Intermediate & Intermediate \\ \hline
\end{tabular}
\end{table}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\chapter{Work Breakdown Structure\documentType}
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{hans_wbs.png} 
		\caption{Work Breakdown Structure for Hans \documentType}
		\label{fig:WBS_Hans}
	\end{figure}
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{nathan_wbs.png} 
		\caption{Work Breakdown Structure for Nathan \documentType}
		\label{fig:WBS_Nathan}
	\end{figure}
	\begin{figure}
		\centering
		\includegraphics[width=0.95\textwidth]{gerald_wbs.png} 
		\caption{Work Breakdown Structure for Gerald \documentType}
		\label{fig:WBS_Gerald}
	\end{figure}
	%\startcontents[chapters]
	%\Mprintcontents 
